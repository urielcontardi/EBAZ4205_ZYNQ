...
HD_PWD='C:/Users/contardii/Desktop/EBAZ4205_ZYNQ/Projects/Interrupt/Vivado/Interrupt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EBAZ4205_Top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EBAZ4205_Top_wrapper.tcl -notrace
