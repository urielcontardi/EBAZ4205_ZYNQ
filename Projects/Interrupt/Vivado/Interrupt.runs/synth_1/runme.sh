...
HD_PWD='C:/Users/contardii/Desktop/EBAZ4205_ZYNQ/Projects/Interrupt/Vivado/Interrupt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EBAZ4205_Top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EBAZ4205_Top_wrapper.tcl
